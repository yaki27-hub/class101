...
-- ✅ 적용 완료 2026-07-27 (Supabase SQL Editor에서 실행됨)
-- ✅ 동작 확인 2026-07-28 — 챗봇 호출 시 chat_count가 한 키에서 누적되는 것 확인(2→4).
--    초기엔 ip_hash가 3개로 갈렸는데(기기·회선이 달랐거나 IPv6 주소 회전),
--    route.ts의 normalizeIp()로 IPv6를 /64 프리픽스로 묶은 뒤에는 한 키로 모인다.
--
