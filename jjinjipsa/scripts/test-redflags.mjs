...
const MUST_FIRE = [
  ...
  // ── 예방 가드가 실제 노출을 놓치면 안 된다 (노출 표지 우선)
  ["2-4 중독", "백합을 집에 두고 나왔어", "toxin"],
  ["2-4 중독", "이물질을 먹은것같아 휴지약간", "toxin"],
  ["2-4 중독", "방금 자일리톨 껌 씹었어요 먹여도 될까요?", "toxin"],
];
...
const MUST_NOT_FIRE = [
  ...
  "예방접종 일정이 궁금해요",
  "우리 애가 요즘 잘 놀아요",
  // ── 예방·정보 문의 (지시서 P0-3) — 노출 사건이 없으므로 룰 미발동, LLM이 예방 안내
  "식물을 들이려고 하는데 몬스테라 집에 둬도 될까?",
  "백합 들여도 될까?",
  "자일리톨 껌 먹여도 돼?",
  "양파는 왜 위험해?",
  "타이레놀은 고양이한테 뭐가 위험한가요?",
  "실 장난감 사줘도 될까?",
  "초콜릿 냄새만 맡게 해도 되나요?",
  "디퓨저 놔둬도 될까?",
  "포도 한 알 줘도 괜찮을까요?",
